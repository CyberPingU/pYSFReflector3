            ...
            if ( msg[0:6] == b"CONNOK" ):
                ...
                for item in resp:
                    ...
                    if ( item == "stream_start" ):
                        ...
                        dgid_val = resp.get("dgid")
                        if dgid_val is not None and dgid_val.isdigit():
                            dgid_clean = str(int(dgid_val))
                        else:
                            dgid_clean = "?"
                        strm_rec["gid_desc"] = gid_desc.get(dgid_clean, "N/A")
                    ...
                    if ( item == "linked" ):
                        ...
                        if dgid_val is not None and dgid_val.isdigit():
                            ...
                            dgid_clean = "?"
                        lnkd_rec["DGID"] = dgid_val + " (" + gid_desc.get(dgid_clean, "not assigned") + ")"
                        if ( resp["T_HOLD"] == "0" ):
